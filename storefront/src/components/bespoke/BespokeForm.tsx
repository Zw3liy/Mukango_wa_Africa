      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
        <div>
          ...
          >
            ...
            <option value="3000_7500">$3,000 – $7,500</option>
            <option value="7500_15000">$7,500 – $15,000</option>
            <option value="15000_plus">$15,000+ (Full Residence / Lodge Suite)</option>
          </select>
        </div>
